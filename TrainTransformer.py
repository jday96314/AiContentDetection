...
def SetupDataLoaders(persuade_sampling_proportion, model_name, batch_size, max_sequence_length, training_example_count, cross_validation_fold_id):
...
def RunExperiments(max_learning_rate, label_smoothing, output_subdir):
    ...
    for trial_id in range(1):
        auroc = TrainModel(
            ...
            training_example_count = 27 * 50000, 
            # training_example_count = 5 * 50000,
...
if __name__ == '__main__':
    # Typically lr 4e-5 for Deberta V3 xsmall
    # Typically lr 2e-5 for Deberta V3 base
    # Typically lr 5e-6 for Deberta V3 large
